    ...
    const SignUpPage = () => {
      ...
      const handleSubmit = async (e) => {
        ...
        if (data.user && data.user.identities && data.user.identities.length === 0) {
            setError("Este e-mail já está cadastrado, mas precisa de confirmação. Verifique sua caixa de entrada.");
            toast({ title: "Verificação Pendente", description: "Este e-mail já está cadastrado, mas precisa de confirmação. Verifique sua caixa de entrada.", variant: "default" });
        ...
        if (data.user) {
          ...
          navigate('/verificar-email');
           ...
           setError("Ocorreu um problema no cadastro. Verifique os dados e tente novamente.");
           toast({ title: "Erro Inesperado", description: "Não foi possível completar o cadastro.", variant: "destructive" });
        }
      };
